...
import jp.co.internous.ecsite.model.from.GoodsForm;
...
public class AdminController {
	...
	@RequestMapping("/torokumst")
	public String torokuMst(LoginForm form,Model m) {
		m.addAttribute("userName",form.getUserName());
		m.addAttribute("password",form.getPassword());
	...
	@RequestMapping("/addToroku")
	public String addToroku(GoodsForm goodsForm,LoginForm loginForm,Model m) {
		m.addAttribute("userName",loginForm.getUserName());
		m.addAttribute("password",loginForm.getPassword());
		m.addAttribute("fullName",loginForm.getfullName());
		
		User user=new User();
		user.setUserName(loginForm.getUserName());
		user.setPassword(loginForm.getPassword());
		user.setFullName(loginForm.getfullName());
